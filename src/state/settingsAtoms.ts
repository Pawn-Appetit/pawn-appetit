...
export const moveNotationTypeAtom = atomWithStorage<"letters" | "symbols" | "letters-translated">(
    "letters",
    "symbols",
);
...
export const showDashboardOnStartupAtom = atomWithStorage<boolean>(
...
export const showPlayInSidebarAtom = atomWithStorage<boolean>(
    "show-play-in-sidebar",
    false,
    undefined,
    {
        getOnInit: true,
...
export const showAnalyzeInSidebarAtom = atomWithStorage<boolean>(
    "show-analyze-in-sidebar",
    false,
    undefined,
    {
        getOnInit: true,
...
export const showPuzzlesInSidebarAtom = atomWithStorage<boolean>(
    "show-puzzles-in-sidebar",
    false,
    undefined,
    {
        getOnInit: true,
