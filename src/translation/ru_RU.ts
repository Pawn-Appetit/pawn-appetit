export const ru_RU = {
  ...
  translation: {
    ...
    "Settings.Anarchy.ForcedEnPassant": "Принудительное взятие на проходе",
    "Settings.Anarchy.ForcedEnPassant.Desc": "Заставляет сделать ход взятия на проходе, если это легальный ход.",
