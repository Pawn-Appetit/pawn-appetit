export const en_US = {
  ...
  translation: {
    ...
    "Common.Or": "Or",
    "Common.ClickToSelectPGN": "Click to select PGN file",
    "Common.Size": "Size",
    "Common.GeneralSettings": "General settings",
    "Common.Data": "Data",
    "Common.Games_one": "{{count, number}} game",
    "Common.Games_other": "{{count, number}} games",
    "Common.Edit": "Edit",
    ...
    "Dashboard.Card.Learn.Title": "Learn Chess",
    "Dashboard.Card.Learn.Desc": "Interactive lessons to learn chess from basics to advanced strategies",
    "Dashboard.Card.Learn.Button": "Start Learning",

    "Lessons.Title": "Chess Lessons",
    "Lessons.SelectToBegin": "Select a lesson to begin learning chess",
    ...
    "Lessons.StartExercise": "Start Exercise",
    "Lessons.Exercises": "Exercises",
    "Lessons.Correct": "Correct! Well done.",
    "Lessons.Incorrect": "Incorrect. Try again.",
    "Lessons.Progress": "Progress",
    "Lessons.OverallProgress": "Overall Progress",
    "Lessons.ShowHint": "Show Hint",
    "Lessons.Hint": "Hint",
    "Lessons.TryMoves": "Try one of these moves",
    ...
    "Practice.SelectExercise": "Select an exercise to begin practicing",
    "Practice.Progress": "Progress",
    "Practice.Exercises": "Exercises",
    "Practice.Completed": "Completed",
    "Practice.Start": "Start Practice",
    "Practice.ShowHint": "Show Hint",
    "Practice.HintText": "Look for tactical opportunities or key squares that control the position.",
    "Practice.Congratulations": "Congratulations!",
    "Practice.CompletedCategory": "You've completed all exercises in {{category}}!",
    ...
    "Tab.ImportGame.Button": "Import game",
    "Tab.ImportGame.URL": "Game URL (lichess or chess.com)",
    "Tab.ImportGame.SaveToCollection": "Save to collection",
    "Tab.ImportGame.Online": "Online",
    "Tab.ImportGame.Importing": "Importing...",
    "Tab.ImportGame.Import": "Import",
    "Tab.Puzzle.Title": "Puzzles",
    "Tab.Puzzle.Desc": "Train your chess skills",
    "Tab.Puzzle.Button": "Solve now",

    "Dashboard.Welcome.FirstOpen": "Welcome to Pawn Appétit!",
    "Dashboard.Welcome.Back": "Welcome back",
    "Dashboard.Welcome.Desc": "Ready to make your next best move?",
    "Dashboard.Card.PlayChess.Title": "Play a game",
    "Dashboard.Card.PlayChess.Desc": "Challenge an engine or a friend",
    "Dashboard.Card.PlayChess.Button": "Play Now",
    "Dashboard.Card.AnalysisBoard.Title": "Analysis Board",
    "Dashboard.Card.AnalysisBoard.Desc": "Analyze a game or position",
    "Dashboard.Card.AnalysisBoard.Button": "Open",
    "Dashboard.Card.ImportGame.Title": "Import Game",
    "Dashboard.Card.ImportGame.Desc": "Import a game from a PGN",
    "Dashboard.Card.ImportGame.Button": "Import",

    "Dashboard.Card.Analyze.Title": "Board Analysis",
    "Dashboard.Card.Analyze.Desc": "Analyze positions, games, and variations with powerful chess engines.",
    "Dashboard.Card.Analyze.Button": "Analyze",
    "Dashboard.Card.Database.Title": "Database Access",
    "Dashboard.Card.Database.Desc":
      "Explore extensive chess databases and study master games to deepen your understanding.",
    "Dashboard.Card.Database.Button": "Browse",
    ...
    "Dashboard.Card.Engine.Button": "Manage",
    "Dashboard.Card.Puzzle.Title": "Tactical Puzzles",
    "Dashboard.Card.Puzzle.Desc":
      "Sharpen your chess skills with tactical puzzles and enhance your pattern recognition.",
    "Dashboard.Card.Puzzle.Button": "Solve",
    "Dashboard.Card.Account.Title": "Accounts",
    ...
    "Dashboard.Card.Account.Button": "Connect",
    "Dashboard.Card.Import.Title": "Import",
    ...
    "Dashboard.Card.Import.Button": "Import",
    ...
    "Board.Practice.SeeAnswer": "See Answer",
    ...
    "Board.Database.Matches": "{{matches, number}} matches",
    ...
    "Opening.EmptyBoard": "Empty board",
    "Opening.StartingPosition": "Starting position",
    ...
    "Databases.Card.Tournaments": "Tournaments",
    ...
    "Databases.Settings.ReferenceDatabase_short": "Reference",
    ...
    "Files.Create.PGNPlaceholder": "Paste your PGN here...",
    ...
    "Files.Folder": "Folder",
    "Files.Delete": "Delete",
    "Files.Game.Delete.Title": "Remove game",
    "Files.Game.Delete.Desc": "Are you sure you want to remove this game?",
    ...
    "Settings.Anarchy.ForcedEnPassant.Desc": "Forces you to play En Passant, if it's a legal move.",
    "Settings.Appearance.Desc": "Customize the look of the app",
    "Settings.Appearance.ColorScheme": "Color Scheme",
    "Settings.Appearance.ColorScheme.Desc": "Light or dark mode preference",
    "Settings.Appearance.ColorScheme.Auto": "Auto",
    "Settings.Appearance.ColorScheme.Light": "Light",
    "Settings.Appearance.ColorScheme.Dark": "Dark",
    "Settings.Appearance.Theme": "Theme",
    "Settings.Appearance.Theme.Desc": "Choose and customize visual themes",
    "Settings.Appearance.Theme.Custom": "Custom",
    "Settings.Appearance.Theme.Manage": "Manage",
    "Settings.Appearance.Theme.ManageTitle": "Manage Themes",
    "Settings.Appearance.Theme.CustomThemes": "Custom Themes",
    "Settings.Appearance.Theme.BuiltInThemes": "Built-in Themes",
    "Settings.Appearance.Theme.CreateNew": "Create New",
    "Settings.Appearance.Theme.Created": "Theme Created",
    "Settings.Appearance.Theme.CreatedMessage": "Successfully created theme \"{{name}}\"",
    "Settings.Appearance.Theme.Edit": "Edit theme",
    "Settings.Appearance.Theme.Duplicate": "Duplicate theme",
    "Settings.Appearance.Theme.Duplicated": "Theme Duplicated",
    "Settings.Appearance.Theme.DuplicatedMessage": "Successfully created \"{{name}}\"",
    "Settings.Appearance.Theme.Export": "Export theme",
    "Settings.Appearance.Theme.Exported": "Theme Exported",
    "Settings.Appearance.Theme.ExportedMessage": "Successfully exported theme \"{{name}}\"",
    "Settings.Appearance.Theme.ExportFailed": "Export Failed",
    "Settings.Appearance.Theme.ExportFailedMessage": "Could not export theme.",
    "Settings.Appearance.Theme.Delete": "Delete theme",
    "Settings.Appearance.Theme.Import": "Import Theme",
    "Settings.Appearance.Theme.ImportFromFile": "Import from file",
    "Settings.Appearance.Theme.ImportFromJSON": "Import from JSON",
    "Settings.Appearance.Theme.ImportTheme": "Import Theme",
    "Settings.Appearance.Theme.ImportDesc": "Paste the JSON content of a theme file below:",
    "Settings.Appearance.Theme.ImportPlaceholder": "Paste theme JSON here...",
    "Settings.Appearance.Theme.Imported": "Theme Imported",
    "Settings.Appearance.Theme.ImportedMessage": "Successfully imported \"{{name}}\"",
    "Settings.Appearance.Theme.ImportFailed": "Import Failed",
    "Settings.Appearance.Theme.ImportFailedMessage": "Invalid theme file format",
    "Settings.Appearance.Theme.NoCustomThemes": "No custom themes yet. Create your first custom theme to get started.",
    "Settings.Appearance.Theme.BuiltIn": "Built-in",
    "Settings.Appearance.Theme.Apply": "Apply Theme",
    "Settings.Appearance.Theme.Applied": "Theme Applied",
    "Settings.Appearance.Theme.AppliedMessage": "Applied theme \"{{name}}\"",
    "Settings.Appearance.Theme.Name": "Theme Name",
    "Settings.Appearance.Theme.NameRequired": "Theme name is required",
    "Settings.Appearance.Theme.NamePlaceholder": "Enter theme name",
    "Settings.Appearance.Theme.Description": "Description",
    "Settings.Appearance.Theme.DescriptionPlaceholder": "Enter theme description",
    "Settings.Appearance.Theme.Author": "Author",
    "Settings.Appearance.Theme.AuthorPlaceholder": "Enter author name",
    "Settings.Appearance.Theme.Create": "Create",
    "Settings.Appearance.Theme.ImportFile": "Import File",
    "Settings.Appearance.Theme.CreateError": "Failed to create theme",
    "Settings.Appearance.Theme.DeleteError": "Failed to delete theme",
    "Settings.Appearance.Theme.DuplicateError": "Failed to duplicate theme",
    "Settings.Appearance.Theme.ExportError": "Failed to export theme",
    "Settings.Appearance.Theme.ImportError": "Failed to import theme",
    "Settings.Appearance.Theme.Deleted": "Theme Deleted",
    "Settings.Appearance.Theme.DeletedMessage": "Deleted theme \"{{name}}\"",
    "Settings.Appearance.Theme.VisualEditor": "Visual Editor",
    "Settings.Appearance.Theme.Updated": "Theme Updated", 
    "Settings.Appearance.Theme.UpdatedMessage": "Successfully updated theme \"{{name}}\"",
    "Settings.Appearance.Theme.SaveError": "Failed to save theme",
    "Settings.Appearance.Theme.EditTheme": "Edit Theme",
    "Settings.Appearance.Theme.HidePreview": "Hide Preview",
    "Settings.Appearance.Theme.ShowPreview": "Show Preview",
    "Settings.Appearance.Theme.Basic": "Basic Settings",
    "Settings.Appearance.Theme.Colors": "Colors",
    "Settings.Appearance.Theme.Components": "Components",
    "Settings.Appearance.Theme.PrimaryColor": "Primary Color",
    "Settings.Appearance.Theme.DefaultRadius": "Default Radius",
    "Settings.Appearance.Theme.FontFamily": "Font Family",
    "Settings.Appearance.Theme.MonospaceFont": "Monospace Font",
    "Settings.Appearance.Theme.Scale": "Scale",
    "Settings.Appearance.Theme.LuminanceThreshold": "Luminance Threshold",
    "Settings.Appearance.Theme.FontSmoothing": "Font Smoothing",
    "Settings.Appearance.Theme.AutoContrast": "Auto Contrast",
    "Settings.Appearance.Theme.FocusRing": "Focus Ring",
    "Settings.Appearance.Theme.White": "White Color",
    "Settings.Appearance.Theme.Black": "Black Color",
    "Settings.Appearance.Theme.ColorPalettes": "Color Palettes",
    "Settings.Appearance.Theme.AddColor": "Add Color",
    "Settings.Appearance.Theme.NewColorName": "Enter color name",
    "Settings.Appearance.Theme.Auto": "Auto",
    "Settings.Appearance.Theme.AutoDesc": "Automatically matches system preference",
    ...
    "Settings.Appearance.hideDashboardOnStartup": "Hide Dashboard on Startup",
    "Settings.Appearance.hideDashboardOnStartup.Desc": "Open Boards instead of Dashboard when the app starts",
    "Settings.Appearance.DateFormat": "Date Format",
    "Settings.Appearance.DateFormat.Desc": "Choose between international (YYYY-MM-DD) or locale-specific date format",
    "Settings.Appearance.DateFormat.International": "International",
    "Settings.Appearance.DateFormat.Locale": "Locale-specific",
    ...
    "Settings.Telemetry.Desc": "Help improve Pawn Appétit by sharing anonymous usage data",
    ...
    "Settings.MoveNotation.TranslatedLetters": "Translated Letters (K Q R B N)",
    "Settings.WaysToMovePieces": "Ways to Move Pieces",
    "Settings.WaysToMovePieces.Desc": "Move pieces by dragging, clicking, or both",
    "Settings.WaysToMovePieces.Drag": "Drag",
    "Settings.WaysToMovePieces.Click": "Click",
    "Settings.WaysToMovePieces.Both": "Both",
    "Settings.SearchPlaceholder": "Search settings",
    "Settings.NoResultsFound": "No settings found for",
    ...
    "GameNotation.HideMoves": "Hide moves",
    "GameNotation.ShowComments": "Show comments",
    "GameNotation.HideComments": "Hide comments",
    "GameNotation.ShowVariations": "Show Variations",
