export const uk_UA = {
  ...
  translation: {
    ...
    "Common.Data": "Дані",
    "Common.Games_one": "{{count}} гра",
    "Common.Games_few": "{{count}} ігри",
    "Common.Games_many": "{{count}} ігор",
    "Common.Games_other": "{{count}} гри",
    ...
    "Dashboard.Card.PlayChess.Title": "Грати в шахи",
    "Dashboard.Card.PlayChess.Desc": "Грайте проти движка або друга",
    "Dashboard.Card.PlayChess.Button": "Грати",
    "Dashboard.Card.AnalysisBoard.Title": "Аналіз дошки",
    "Dashboard.Card.AnalysisBoard.Desc": "Аналізуйте гру або позицію",
    "Dashboard.Card.AnalysisBoard.Button": "Відкрити",
    "Dashboard.Card.ImportGame.Title": "Імпорт гри",
    "Dashboard.Card.ImportGame.Desc": "Імпортуйте гру з файлу PGN",
    "Dashboard.Card.ImportGame.Button": "Імпортувати",
    "Dashboard.Card.Puzzle.Title": "Головоломки",
    "Dashboard.Card.Puzzle.Desc": "Тренуйте шахові навички",
    "Dashboard.Card.Puzzle.Button": "Тренуватися",
    ...
    "Settings.Anarchy.ForcedEnPassant": "Примусове взяття на проході",
    "Settings.Anarchy.ForcedEnPassant.Desc": "Змушує вас зробити хід взяття на проході, якщо це легальний хід.",
