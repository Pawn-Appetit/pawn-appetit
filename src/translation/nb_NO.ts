export const nb_NO = {
  ...
  translation: {
    ...
    "Common.Data": "Data",
    "Common.Games_one": "{{count}} spill",
    "Common.Games_other": "{{count}} spill",
    "Common.Edit": "Rediger",
    ...
    "Dashboard.Card.PlayChess.Title": "Spill Sjakk",
    "Dashboard.Card.PlayChess.Desc": "Spill mot computer eller en venn",
    "Dashboard.Card.PlayChess.Button": "Spill",
    "Dashboard.Card.AnalysisBoard.Title": "Analysebrett",
    "Dashboard.Card.AnalysisBoard.Desc": "Analyser et parti eller en stilling",
    "Dashboard.Card.AnalysisBoard.Button": "Åpne",
    "Dashboard.Card.ImportGame.Title": "Importer Parti",
    "Dashboard.Card.ImportGame.Desc": "Importer et parti fra en PGN",
    "Dashboard.Card.ImportGame.Button": "Importer",
    "Dashboard.Card.Puzzle.Title": "Sjakknøtter",
    "Dashboard.Card.Puzzle.Desc": "Tren sjakkferdighetene dine",
    "Dashboard.Card.Puzzle.Button": "Tren",
    ...
    "Settings.Anarchy.ForcedEnPassant": "Tvunget i forbigåelsen",
    "Settings.Anarchy.ForcedEnPassant.Desc": "Tvinger deg til å spille i forbigåelsen, hvis det er et lovlig trekk.",
