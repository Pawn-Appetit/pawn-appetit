export const pt_PT = {
  ...
  translation: {
    ...
    "Common.Data": "Dados",
    "Common.Games_one": "{{count}} jogo",
    "Common.Games_other": "{{count}} jogos",
    "Common.Edit": "Editar",
    ...
    "Dashboard.Card.PlayChess.Title": "Jogar xadrez",
    "Dashboard.Card.PlayChess.Desc": "Jogue contra um engine ou um amigo",
    "Dashboard.Card.PlayChess.Button": "Jogar",
    "Dashboard.Card.AnalysisBoard.Title": "Tabuleiro de análise",
    "Dashboard.Card.AnalysisBoard.Desc": "Analizar um jogo ou uma posição",
    "Dashboard.Card.AnalysisBoard.Button": "Abrir",
    "Dashboard.Card.ImportGame.Title": "Importar jogo",
    "Dashboard.Card.ImportGame.Desc": "Importar game de um ficheiro PGN",
    "Dashboard.Card.ImportGame.Button": "Importar",
    "Dashboard.Card.Puzzle.Title": "Puzzles",
    "Dashboard.Card.Puzzle.Desc": "Treinar habilidades de xadrez",
    "Dashboard.Card.Puzzle.Button": "Treinar",
    ...
    "Engines.Remove.Message": "Tens a certeza que queres remover este engine do Pawn Appétit?",
    ...
    "Settings.Anarchy.ForcedEnPassant": "en passant forçado",
    "Settings.Anarchy.ForcedEnPassant.Desc": "Obriga jogar en passant, caso seja uma jogada legal.",
