export const pl_PL = {
  ...
  translation: {
    ...
    "Common.Data": "Dane",
    "Common.Games_one": "{{count}} gra",
    "Common.Games_few": "{{count}} gry",
    "Common.Games_many": "{{count}} gier",
    "Common.Games_other": "{{count}} gry",
    "Common.Edit": "Edytuj",
    ...
    "Dashboard.Card.PlayChess.Title": "Graj w szachy",
    "Dashboard.Card.PlayChess.Desc": "Graj przeciwko silnikowi lub przyjacielowi",
    "Dashboard.Card.PlayChess.Button": "Graj",
    "Dashboard.Card.AnalysisBoard.Title": "Tablica analizy",
    "Dashboard.Card.AnalysisBoard.Desc": "Analizuj grę lub pozycję",
    "Dashboard.Card.AnalysisBoard.Button": "Otwórz",
    "Dashboard.Card.ImportGame.Title": "Importuj grę",
    "Dashboard.Card.ImportGame.Desc": "Importuj grę z pliku PGN",
    "Dashboard.Card.ImportGame.Button": "Importuj",
    "Dashboard.Card.Puzzle.Title": "Zagadki",
    "Dashboard.Card.Puzzle.Desc": "Trenuj swoje umiejętności szachowe",
    "Dashboard.Card.Puzzle.Button": "Trenuj",
    ...
    "Settings.Anarchy.ForcedEnPassant": "Wymuszone bicie w przelocie",
    "Settings.Anarchy.ForcedEnPassant.Desc": "Zmusi cię do zagrania bicia w przelocie, jeśli jest to legalny ruch.",
